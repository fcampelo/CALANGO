#' # functions borrowed/adapted from package taxize 
#' # https://CRAN.R-project.org/package=taxize 
#' # which was orphaned in CRAN as of 3 Sep 2024
#' 
...
#' #' Added by Felipe Campelo {f.campelo@bristol.ac.uk} on 3 Sep 2024 in package 
#' #' CALANGO.
...
#' #' values.
#' #' @author Vinh Tran {tran@bio.uni-frankfurt.de}
#' #' Edited by Felipe Campelo {f.campelo@bristol.ac.uk} on 3 Sep 2024 for package 
#' #' CALANGO.
...
#'               # list of current ranks whose index should be increased
...
#'   t_full_rank_name_df <- data.table::transpose(full_rank_name_df)
#'   
...
#'   out <- ape::as.phylo.hclust(stats::hclust(taxdis, ...))
